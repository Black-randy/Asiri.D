...
const Squares: React.FC<SquaresProps> = ({
  ...
  useEffect(() => {
    ...
    // Set movement direction based on the specified direction
    const getDirection = () => {
      switch (direction) {
    ...
    const initSquares = () => {
      ...
      // Add extra squares to ensure the entire viewport is covered
    ...
    const resizeCanvas = () => {
      ...
      initSquares(); // Reinitialize squares
    };
    resizeCanvas();
    ...
    const animate = () => {
      ...
      squares.forEach(square => {
        ...
        // Boundary check - Adjust boundary conditions to ensure seamless connection
        ...
        // Draw squares - Ensure squares fully cover their area
