        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 order-2 md:order-1">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <span className="text-sm font-medium">Hello, I am</span>
              </div>
              
              {theme === 'dark' ? (
                <div className="text-5xl sm:text-6xl lg:text-7xl font-bold animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="relative order-1 md:order-2">
            <div className="relative w-64 h-64 md:w-80 md:h-80 mx-auto">
              ...
              <OptimizedImage 
                src={theme === 'dark' ? '/Hero_image_001.png' : '/Hero_image_000.png'}
                alt="Asiri.D" 
                width={1000}
                height={1000}
                priority={true}
              ...
              <div className="absolute -bottom-4 -right-4 w-16 h-16 rounded-2xl bg-primary/10 backdrop-blur-sm flex items-center justify-center border border-primary/20">
                <img
                  src={theme === 'dark' ? '/logo/Logo-A-Light.png' : '/logo/Logo-A-Dark.png'}
                  alt="Logo A"
