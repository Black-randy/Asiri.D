...
export function ContactSection() {
  ...
  // Only display the first 5 friends
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="relative group/desc">
                      ...
                      <div className="absolute left-0 top-full mt-1 p-2 bg-background text-foreground text-xs rounded-md shadow-lg border border-[hsl(var(--border))] opacity-0 invisible group-hover/desc:opacity-100 group-hover/desc:visible transition-all duration-200 z-50 max-w-[200px]">
                        {friend.description}
                      </div>
                    </div>
                  </div>
